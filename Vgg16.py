...
class Vgg16:
    ...
    def __init__(self, model_path=None):
    	...
    	self.rgbImages = tf.placeholder("float", [None, 224, 224, 3])
    	self._buildModel(self.rgbImages)
	...
	'''
	Build the model using the loaded weights
	'''
    def _buildModel(self, rgbImages):
    	
    	bgrMeanSubtractedImage = self._preprocessImageAsPerVGG16(rgbImages)

    	self.conv1_1 = self._conv_layer(bgrMeanSubtractedImage, "conv1_1")
